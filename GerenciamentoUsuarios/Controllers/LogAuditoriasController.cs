...
{
    public class LogAuditoriasController : BaseController
    {
        ...
        {
            var temAcesso = await UsuarioTemAcesso(5, _context);
            if (!temAcesso)
            {
        ...
        public async Task<IActionResult> Create([Bind("Id,Descricao,DataHora,Usuario")] LogAuditoria logAuditoria)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descricao,DataHora,Usuario")] LogAuditoria logAuditoria)
        {
